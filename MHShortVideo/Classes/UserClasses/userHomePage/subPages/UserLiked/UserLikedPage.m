...
@interface UserLikedPage ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
-(void)buildCollectionView
{
    ...
    [self.collectionView registerClass:[UserProductionCell class] forCellWithReuseIdentifier:@"yonghuxihuandezuopinliebiaocellid"];
...
{
    UserProductionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"yonghuxihuandezuopinliebiaocellid" forIndexPath:indexPath];
