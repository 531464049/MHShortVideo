...
{
    [self cw_registerShowIntractiveWithEdgeGesture:openEdgeGesture configuration:nil transitionDirectionAutoBlock:transitionDirectionAutoBlock];
    
}
-(void)cw_registerShowIntractiveWithEdgeGesture:(BOOL)openEdgeGesture configuration:(CWLateralSlideConfiguration *)configuration transitionDirectionAutoBlock:(void (^)(CWDrawerTransitionDirection))transitionDirectionAutoBlock
{
    CWLateralSlideAnimator *animator = [CWLateralSlideAnimator lateralSlideAnimatorWithConfiguration:configuration];
